      ...
      >
        <el-form ref="form" :model="formData" label-width="80px" size="mini" :rules="rules">
          <el-form-item label="姓名" prop="unitName">
            <el-input v-model="formData.unitName" placeholder="请输入姓名"></el-input>
          </el-form-item>
          <el-form-item label="手机号码" prop="phone">
            <el-input v-model="formData.phone" placeholder="请输入手机号"></el-input>
          </el-form-item>
          <el-form-item label="身份证号" prop="remark">
            <el-input v-model="formData.remark" placeholder="请输入身份证号"></el-input>
          </el-form-item>
          <el-form-item >
      ...
      return {
        ...
        rules: {
          ...
          remark: [
            ...
            { min: 12, max: 18, message: '不符合身份证位数规范', trigger: 'blur' }
          ],
          phone: [
