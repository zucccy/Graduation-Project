  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-lx-cascades"></i>医院管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="hospitalName" label="医院名"></el-table-column>
    ...
    <el-dialog title="新增" v-model="addVisible" width="30%">
      <el-form ref="form" :model="form" label-width="70px">
        <el-form-item label="医院名" >
          <el-input v-model="form.hospitalName" placeholder="请输入医院名"></el-input>
        </el-form-item>
        <el-form-item label="地址" >
        ...
        <el-form-item label="精度" >
          <el-input v-model="form.longitudes" placeholder="请输入地址精度"></el-input>
        </el-form-item>
        <el-form-item label="纬度" >
          <el-input v-model="form.latitudes" placeholder="请输入地址纬度"></el-input>
        </el-form-item>
      </el-form>
      <template #footer>
        <span class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    handleDelete(index) {
      ...
      this.$confirm("确定要删除吗？", "提示", {
        ...
        .then(() => {
          ...
          deleteData(this.query1).then((res) => {
            console.log(res);
            if (res.code != 200) {
              this.$alert(res.msg);
            }else {
    ...
    saveEdit() {
      ...
      this.query2.hospitalName = this.form.hospitalName;
      this.query2.address = this.form.address;
      ...
      updateData(this.query2).then((res) => {
        console.log(res);
        if (res.code != 200) {
              this.$alert(res.msg);
            }else {
    ...
    // 保存新增
      saveAdd() {
        ...
        console.log(this.form);
        this.query3.hospitalName = this.form.hospitalName;
        this.query3.address = this.form.address;
        this.query3.description = this.form.description;
        this.query3.phone = this.form.phone;
        this.query3.src = this.form.src;
        this.query3.longitudes = this.form.longitudes;
        this.query3.latitudes = this.form.latitudes;
        console.log(this.query3);
        insertData(this.query3).then((res) => {
        console.log(res);
        if (res.code != 200) {
              this.$alert(res.msg);
            }else {
